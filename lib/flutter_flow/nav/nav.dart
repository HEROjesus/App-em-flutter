...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const DashbordWidget() : const Auth3CreateWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Home23TaskDashboadResponsive',
          path: '/home23TaskDashboadResponsive',
          builder: (context, params) => const Home23TaskDashboadResponsiveWidget(),
        ),
        FFRoute(
